...
import Logo1 from "../../Image/Books/New folder/File.jpg";
import Logo2 from "../../Image/Books/New folder/File.jpg";
import Logo3 from "../../Image/Books/New folder/File.jpg";

import logoSubImage1 from "../../Image/Books/New folder/Mock-1.jpg";
import logoSubImage2 from "../../Image/Books/New folder/Mock-2.jpg";
import logoSubImage3 from "../../Image/Books/New folder/Mock-3.jpg";
import logoSubImage4 from "../../Image/Books/New folder/Mock-4.jpg";
import logoSubImage5 from "../../Image/Books/New folder/Mock-5.jpg";

import BooksCoverDesign1 from "../../Image/Books/New folder/File.jpg";
import BooksCoverDesign2 from "../../Image/Books/New folder/File.jpg";
import BooksCoverDesign3 from "../../Image/Books/New folder/File.jpg";
...
const Protfolio = () => {
  ...
  const LogoSubImageCatagoryCard = [
    {
      id: 1_1,
      img: logoSubImage1,
    },
  ...
  return (
    <main className={`w-[100%] h-[100%] flex relative GeologicaFont bg-[#fff]`}>
      <div className="[@media(min-width:1500px)]:w-[1500px] w-[100%] h-[100%] mx-auto flex flex-col Quicksand ">
        ...
        <div
          className={`${
            onClickProjectLi3 ? "hidden" : "grid"
          }  [@media(min-width:1115px)]:!grid-cols-3 [@media(min-width:650px)]:grid-cols-2 grid-cols-1 justify-center items-center w-full [@media(min-width:450px)]:pt-[25px] pt-[10px] pb-[3rem] relative`}
        >
          {Catagory.map((catagory) => (
            <div key={catagory.id} className="w-[100%]">
              <label
                data-aos="fade-up"
                className={`w-[94%] h-[100%] overflow-hidden mx-auto my-[15px] relative flex justify-center items-center cursor-pointer shadow-[0px_0px_6px_0px_#0000000f]`}
              >
                <div
                  onClick={() => {
      ...
      {/* Pop Up Img */}
      <div
        className={`w-[100%] h-full Poppins fixed top-0 left-0 right-0 ${
          showPopUpImg ? `${onClickProjectLi3 ? "hidden" : "flex"}` : "hidden"
        } justify-center items-center z-50  bg-[#fffffff7]`}
      >
        <div className="w-[100%] mx-auto [@media(min-width:740px)]:h-full h-[100vh] [@media(min-width:740px)]:min-h-full min-h-[100vh] flex justify-center [@media(min-width:740px)]:items-center items-start absolute left-0 top-0 overflow-y-auto scrollbar-hide z-[29] [@media(min-width:740px)]:py-[2rem] py-0">
          <div className="[@media(min-width:1420px)]:w-[1420px] w-[100%] [@media(min-width:740px)]:h-full flex [@media(min-width:740px)]:flex-row flex-col justify-center [@media(min-width:1500px)]:px-0 px-[1rem]">
            <img
              src={popUpImg}
              className="h-full w-auto [@media(min-width:740px)]:flex hidden"
            />
            <img
              src={popUpImg}
              className="w-[95%] [@media(min-width:740px)]:hidden flex pt-[4rem] [@media(min-width:740px)]:pb-[2rem] pb-[0.5rem] mx-auto"
            />
            <div className="w-fit h-full grid [@media(min-width:940px)]:grid-cols-2 grid-cols-1 justify-center [@media(min-width:740px)]:overflow-y-auto overflow-y-visible [@media(min-width:940px)]:!pl-[1.5rem] [@media(min-width:740px)]:pl-[1rem] pl-0 scrollbar-hide [@media(min-width:740px)]:py-0 py-[2rem]">
              {LogoSubImageCatagoryCard.map((key) => {
                return (
                  <div key={key.id} className="w-[95%] [@media(min-width:940px)]:mb-[1.5rem] mb-[1rem] mx-auto">
          ...
          className={`[@media(min-width:555px)]:w-[35px] w-[25px] [@media(min-width:555px)]:h-[35px] h-[25px] flex [@media(min-width:555px)]:text-[45px] text-[35px] text-[#818181] rotate-[45deg] text-center justify-center items-center absolute [@media(min-width:555px)]:top-[1rem] top-[23px] [@media(min-width:555px)]:right-[1rem] right-[14px] cursor-pointer z-[60]`}
        >
          +
        </p>
        </div>
